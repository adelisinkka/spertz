    ...
    (function () {
      ...
      const validCodes = new Map([
        ["0902", { colors: ["#76d5ff", "#9e8cff", "#ffe182"] }],
        ["888888888", { colors: ["#ff8ac6", "#ffd36e", "#8cf7d2"] }],
        ["ffzfzzfdzfmzfvzfkzfrzftzf", { colors: ["#7df1ff", "#f5a6ff", "#f7f3a1"] }]
      ]);
      const glyphs = ["✦", "✧", "✺", "◌", "☼", "⟡", "⟢", "⟣"];
      ...
      function launchEffect(palette) {
        ...
        for (let i = 0; i < particleCount; i += 1) {
          ...
          particle.style.setProperty("--dur", `${1600 + Math.random() * 1100}ms`);
          particle.style.setProperty("--particle-core", `${palette[i % palette.length]}cc`);
        ...
        cleanupTimer = setTimeout(clearEffect, 3200);
      }
      ...
      form.addEventListener("submit", (event) => {
        ...
        launchEffect(effect.colors);
        setStatus(IS_ZH ? "代码已识别。隐藏星纹已展开。" : "Code accepted. Hidden starlight released.", "success");
        input.value = "";
      });
    })();
