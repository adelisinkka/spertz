    ...
    (function () {
      ...
      const NOUNS = [
        ...
        ["duab", "something good", "[d'wab]", "duab"],
        ...
        ["spiretz", "peace", "[spiɹ'etsiː]", "s.pi.re.tsyi"],
  ...
  randomBirthBtn.addEventListener("click", randomBirthday);
    ...
    (function () {
      ...
      const NOUNS = [
        ...
        { sp: "baud", meaning: "something bad", pronunciation: "[b'aud]", syllables: "baud" },
        ...
        { sp: "duab", meaning: "something good", pronunciation: "[d'wab]", syllables: "duab" },
        ...
        { sp: "spiretz", meaning: "peace", pronunciation: "[spiɹ'etsiː]", syllables: "s.pi.re.tsyi" },
      ...
      if (verbTbody) {
        const sortedVerbs = VERBS.slice().sort((a, b) => a[0].localeCompare(b[0], "en", { sensitivity: "base" }));
