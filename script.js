    ...
    (function () {
      ...
      function clearEffect() {
        overlay.classList.remove("effect-burst", "effect-rain", "effect-halo", "effect-violet", "effect-laser", "effect-thunder", "effect-elements", "effect-iceworld");
      ...
      function createLaserCore() {
        const core = document.createElement("span");
        core.className = "secret-laser-core";
      ...
      function launchThunder() {
        ...
        bolt.innerHTML = `
          <svg viewBox="0 0 120 180" aria-hidden="true">
            <path d="M72 10 L44 82 H72 L54 170 L96 92 H68 Z"></path>
          </svg>
        `;
      ...
      function launchIceworld() {
        ...
        tree.innerHTML = `
          <svg viewBox="0 0 180 260" aria-hidden="true">
            <path d="M92 18 L122 72 L106 72 L140 124 L118 124 L154 180 L98 180 L98 232 L82 232 L82 180 L28 180 L64 124 L42 124 L76 72 L58 72 Z"></path>
            <path d="M86 180 L94 180 L94 246 L86 246 Z"></path>
          </svg>
        `;
        ...
        drawDiamond.innerHTML = `
          <svg viewBox="0 0 140 140" aria-hidden="true">
            <path d="M70 12 L122 70 L70 128 L18 70 Z"></path>
          </svg>
        `;
        ...
        for (let i = 0; i < littleCount; i += 1) {
          ...
          little.style.setProperty("--delay", `${5600 + i * 40}ms`);
      ...
      function launchEffect(type) {
        ...
        cleanupTimer = setTimeout(clearEffect, type === "iceworld" ? 8200 : type === "elements" ? 6200 : type === "thunder" ? 6800 : type === "laser" ? 7200 : type === "violet" ? 7600 : type === "halo" ? 3800 : 3200);
      }
