    ...
    (function () {
      ...
      const VERB_LEXICON_OVERRIDES = {
        ...
        kuino: { pronunciation: "[kuˈino]", syllables: "ku.i.no" },
      ...
      const NOUNS = [
        ...
        ["coratim", "challenge", "[koɹ'atim]", "co.ra.tim"],
        ["corutal", "country", "[koɹ'utal]", "co.ru.tal"],
        ["cricheik", "decision", "[kɹ'iʧek]", "cri.cheik"],
        ...
        ["fizrat", "dictionary", "[f'izɹat]", "fi.zrat"],
        ...
        ["ta.ris", "month", "[t'aɹis]", "ta.ris"],
        ["da.vir", "day", "[d'aviɹ]", "da.vir"],
        ["da.zu", "hour", "[d'azu]", "da.zu"],
        ["za.lu", "year", "[z'alu]", "za.lu"],
        ["zi.mi", "minute", "[z'imi]", "zi.mi"],
        ...
        ["davir", "today", "[d'aviɹ]", "da.vir"],
        ["i-davir / aminaro", "tomorrow", "[id'aviɹ] / [amin'aɹo]", "i.da.vir / a.mi.na.ro"],
      ...
      const ZH_MEANING = {
        "believe": "相信", "hope": "希望", "have": "拥有", "need, want": "需要、想要",
        ...
        "think": "思考", "challenge": "挑战", "do; make": "做、制造", "decision": "决定",
        ...
        "month": "月", "day": "天", "hour": "小时", "year": "年", "minute": "分钟",
        ...
        "shining": "发亮的", "impossible": "不可能的", "eternal": "永恒的",
        ...
        "mind": "思想", "knowledge": "知识", "wisdom": "智慧", "light, flash": "光、闪光", "pencil": "铅笔",
        ...
        "society": "社会", "peace": "和平", "horse": "马", "course": "课程", "war": "战争",
  ...
  randomBirthBtn.addEventListener("click", randomBirthday);
    ...
    (function () {
      ...
      const NOUNS = [
        ...
        { sp: "coratim", meaning: "challenge", pronunciation: "[koɹ'atim]", syllables: "co.ra.tim" },
        { sp: "corutal", meaning: "country", pronunciation: "[koɹ'utal]", syllables: "co.ru.tal" },
        { sp: "cricheik", meaning: "decision", pronunciation: "[kɹ'iʧek]", syllables: "cri.cheik" },
        ...
        { sp: "fizrat", meaning: "dictionary", pronunciation: "[f'izɹat]", syllables: "fi.zrat" },
        ...
        { sp: "ta.ris", meaning: "month", pronunciation: "[t'aɹis]", syllables: "ta.ris" },
        { sp: "da.vir", meaning: "day", pronunciation: "[d'aviɹ]", syllables: "da.vir" },
        { sp: "da.zu", meaning: "hour", pronunciation: "[d'azu]", syllables: "da.zu" },
        { sp: "za.lu", meaning: "year", pronunciation: "[z'alu]", syllables: "za.lu" },
        { sp: "zi.mi", meaning: "minute", pronunciation: "[z'imi]", syllables: "zi.mi" },
        ...
        { sp: "davir", meaning: "today", pronunciation: "[d'aviɹ]", syllables: "da.vir" },
        { sp: "i-davir / aminaro", meaning: "tomorrow", pronunciation: "[id'aviɹ] / [amin'aɹo]", syllables: "i.da.vir / a.mi.na.ro" },
        ...
        { sp: "duabr", meaning: "white", pronunciation: "[d'wabɹ]", syllables: "duabr" },
      ...
      const ADJECTIVES = [
        ...
        ["fiurigaro", "purple"],
        ["kilori", "yellow"],
        ["ligurika", "shining color"],
        ["metine", "cyan"],
        ["nizori", "bright color"],
        ["noma", "black"],
        ["parine", "light colors; pastel colors"],
        ["rela", "orange"],
        ["takari", "red"],
        ["volio", "green"],
        ["yirona", "purple-pink"],
      ...
      function deriveVerbLexiconEntry(verb) {
        const override = VERB_LEXICON_OVERRIDES[verb];
      ...
      function getVerbLexiconEntrySafe(verb) {
        try {
          return deriveVerbLexiconEntry(verb);
        } catch {
      ...
      if (verbTbody) {
        ...
        sortedVerbs.forEach(([sp, en], idx) => {
          ...
          const meta = getVerbLexiconEntrySafe(sp);
      ...
      if (nounTbody) {
        ...
        sortedNouns.forEach((entry, idx) => {
          ...
          const tr = document.createElement("tr");
          tr.innerHTML = `<td>${idx + 1}</td><td><b>${entry.sp}</b></td><td>${meaning}</td><td>${entry.pronunciation}</td><td>${entry.syllables}</td>`;
      ...
      if (adjectiveTbody) {
        ...
        sortedAdjectives.forEach(([sp, en], idx) => {
          const meaning = IS_ZH ? (meaningMap[en] || en) : en;
          const tr = document.createElement("tr");
          tr.innerHTML = `<td>${idx + 1}</td><td><b>${sp}</b></td><td>${meaning}</td>`;
