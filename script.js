      ...
      function determineEnding() {
        if (guideFollowed) {
          return {
            ...
            summary: "By following the perfect path, you secure the crystal with minimal loss and forge a lasting alliance across the Spiretz League."
          };
        }
        const best =
          state.diplomacy >= 75 &&
...
(function () {
  ...
  randomBirthBtn.addEventListener("click", randomBirthday);
    ...
    // ===== Resources: Spiretz Lexicon (Verbs) =====
    (function () {
